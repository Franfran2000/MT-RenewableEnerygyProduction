...
# Inverter chosen: Power_One__PVI_CENTRAL_250_US__480V_
# Nominal AC power = 250kWp
# Nominal DC power needed = 259210.766 kWp
# Nominal DC input voltage = 360, used to determine string size
...
# Nominal power = 258.11
# Voltage at max power = 48.7V
# to reach 360V, need 7 panels (in series) per string
...
systems = [{
    "inverter_name": "Power_One__PVI_CENTRAL_250_US__480V_",
    "arrays": arrays
    }]
