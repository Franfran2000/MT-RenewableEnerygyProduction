...
class PVModule(RenewModule):
    ...
    def read_params(self, module_names, inverter_names, surface_azimuth, temperature_models):
        #TODO allow modules and inverter to be directly given as argument
        sandia_modules = pvlib.pvsystem.retrieve_sam('SandiaMod')
        sapm_inverters = pvlib.pvsystem.retrieve_sam('cecinverter')
        
        self.system = {}
        
        self.system["module"] = sandia_modules[module_names]
        self.system["inverter"] = sapm_inverters[inverter_names]
        ...
        pvsystem = PVSystem(arrays=[array], inverter_parameters=inverter)
