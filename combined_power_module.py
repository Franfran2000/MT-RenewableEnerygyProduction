    ...
    for cfg in configs:
        ...
        if cfg_type == "pv":
            ...
            for pv_install in pv_installations:
                ...
                pv_weather = wt.get_pv_weather(pv_location) #TODO make weather forecast timeline a parameter
                ...
                modules["pv_modules"].append(pv) # append PVModule object directly #TODO correct arborescence ?
            ...
            for wind_install in wind_installations: 
                ...
                modules["wind_modules"].append(wind)
